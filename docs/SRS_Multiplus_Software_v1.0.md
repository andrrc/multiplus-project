...
**Data:** 10/09/2026
**Autor:** André (Somma)
**Status:** Rascunho — itens da reunião de aprovação da Sprint 2 implementados e validados pelo Claude Code; RN-006 fechado (remove atribuição da pessoa anterior ao trocar responsável)
...
| **User Story vinculada**    | —                                                                                                                                                                                                                                                                                                                                                                                                |
| **Nota de implementação** | Descoberto em teste de integração (Sprint 1): a primeira implementação permitia que o Colaborador Interno concluísse subtarefas de outras pessoas dentro do seu próprio projeto, violando esta regra. Corrigido separando a permissão de "gerir checklist" da permissão de "marcar concluída"                                                                                            |
...
| 1.4     | 02/09/2026 | André | RF-021/RN-004 clarificados: separação explícita entre "gerir checklist" e "marcar concluída", descoberta via teste de integração na Sprint 1 (bug real corrigido).                                                                                                                                                                                                                                                                                                             |
