 ...
 * src/server/auth/credentials.ts, src/lib/clientes.ts) que lê
 * DATABASE_URL/APP_DATABASE_URL na primeira importação — aqui a gente aponta isso
 * pro banco de teste ANTES desse import acontecer, pra nunca sequer tocar no banco
 * de dev.
